...
def _add_prune_args(parser):
    ...
    group.add_argument('--is_prune', action='store_true',
                       help='whether or not to prune the model')
    group.add_argument('--num_attention_heads_remain',type=int, default=None,
                       help='the number of the attention head after pruning')
    group.add_argument('--hidden_size_remain',type=int, default=None,
                       help='the hidden_size after pruning')
    group.add_argument('--ffn_hidden_size_remain',type=int, default=None,
                       help='the intermediate layer size after pruning')
    group.add_argument('--drop_layers', type=str, default=None,
                       help='numbers of the dropped layers, start from 0')
    group.add_argument('--prune_type', type=str, default="balance")
    return parser