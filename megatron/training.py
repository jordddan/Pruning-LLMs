...
def prune(model_provider, model_type, args_defaults=None):
    ...
    with torch.no_grad():
        unwrapped_model.prune(args)


    args.hidden_size = args.hidden_size_remain
    args.ffn_hidden_size = args.ffn_hidden_size_remain
    args.num_attention_heads = args.num_attention_heads_remain
    args.group_query_attention = False
    if args.drop_layers is not None:
        args.num_layers = args.num_layers - len(args.drop_layers.split(","))
...
def train(forward_step_func, model, optimizer, opt_param_scheduler,
    ...
    # # Evaluation
    # if args.eval_interval  and  args.do_valid:
