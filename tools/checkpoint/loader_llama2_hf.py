...
def set_preprocess_state(args, model, hf_model):
    ...
    # if model.language_model.embedding.word_embeddings.weight.shape == torch.Size([32000, 5120]):
    #     new_shape = (32768, 5120)
    #     new_embedding = torch.zeros(new_shape)
    #     new_embedding[:32000, :] = model.language_model.embedding.word_embeddings.weight
    #     model.language_model.embedding.word_embeddings = torch.nn.Embedding.from_pretrained(new_embedding)
...
def set_postprocess_state(args, model, hf_model):
    ...
    # if model.language_model.output_layer.weight.shape == torch.Size([32000, 5120]):
    #     new_shape = (32768, 5120)
    #     new_embedding = torch.zeros(new_shape)
    #     new_embedding[:32000, :] = model.language_model.output_layer.weight
    #     model.language_model.output_layer = torch.nn.Embedding.from_pretrained(new_embedding)
